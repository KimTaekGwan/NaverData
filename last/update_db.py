...
class Updatae_DB:
    ...
    def insert_datas(self, datas:list, table_name:str):
        ...
        self.cur.executemany(f"INSERT INTO {table_name}({cols}) VALUES({values})", datas)
        # pass
    ...
    def _insert_table_col(self, table_name:str):
        t_c = {
            ...
            'Query_Keyword':[],
            'Search_Keyword':[],
            'Keywords_Top':['keyword_id','search_id','ranking','keyword','type'],
            'Data_Product':[],
            'Crawling_store':[],
            'Data_Reviews':[],
            'Data_Posts':[],
...
if __name__ == "__main__":
    db = Updatae_DB("data/ver_0520.db")
    # db.init_db()